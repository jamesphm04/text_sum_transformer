...
def export_to_h5():
    ...
    source = tokenizer_src.encode('Hi, this is a dummy sentence')
    source = torch.cat([
    ...
    keras_model = pytorch_to_keras(model, [source, decoder_input, source_mask, decoder_mask], [400, None, None,], verbose=True)
    return keras_model
